...
<div class="container mt-3">
    <div class="row">
        <div class="col-sm-8 col-md-6">
            <h1 class="h2 pt-4">Tambah Barang Inventaris</h1>
            <hr>
            ...
            <form action="{{url('barang')}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <select name="user_id" id="user_id" class="custom-select col-md-12 @error('user_id') is-invalid @enderror">
                        ...
                        <option value="{{ $user->id }}" {{ ($bangunan['user_id'] ?? '') == $user->id ? 'selected' : ''}}>
                            {{ $user->username }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select name="kategori_id" id="kategori_id" class="custom-select col-md-12 @error('kategori_id') is-invalid @enderror">
                        ...
                        <option value="{{ $kategori->id }}" {{ ($bangunan['kategori_id'] ?? '') == $kategori->id ? 'selected' : ''}}>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('no_seri') is-invalid @enderror" id="no_seri" name="no_seri" value="{{ old('no_seri') }}">
                    @error('no_seri')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control @error('tgl_pengadaan') is-invalid @enderror" id="tgl_pengadaan" name="tgl_pengadaan" value="{{ old('tgl_pengadaan') }}">
                    @error('tgl_pengadaan')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('harga_perolehan') is-invalid @enderror" id="harga_perolehan" name="harga_perolehan" value="{{ old('harga_perolehan') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nilai_residu') is-invalid @enderror" id="nilai_residu" name="nilai_residu" value="{{ old('nilai_residu') }}">
                    @error('nilai_residu')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('umur_ekonomis') is-invalid @enderror" id="umur_ekonomis" name="umur_ekonomis" value="{{ old('umur_ekonomis') }}">
                    @error('umur_ekonomis')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
